-- Nightingale Connect Database Schema - Simple Version (No Recursion)
-- This script creates a simple schema without complex RLS policies
...
-- Messages policies - simple approach
CREATE POLICY "messages_all_policy" ON messages
  FOR ALL USING (true);

-- Rooms policies - simple approach  
CREATE POLICY "rooms_all_policy" ON rooms
  FOR ALL USING (true);

-- Members policies - simple approach
CREATE POLICY "members_all_policy" ON members
  FOR ALL USING (true);

-- Message reads policies - simple approach
CREATE POLICY "message_reads_all_policy" ON message_reads
  FOR ALL USING (true);
...
-- Success message
SELECT 'Simple schema created successfully - no recursion issues!' as status;
